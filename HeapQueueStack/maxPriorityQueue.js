...
function MaxPriorityQueue(callbackObject) {
  //const queue = new MinMaxPriorityQueue({ priority: x => x.val })
  this.custom = callbackObject;
  this.heap = [];
}

MaxPriorityQueue.prototype.swap = function (indexOne, indexTwo) {
  const tmp = this.heap[indexOne];
  this.heap[indexOne] = this.heap[indexTwo];
  this.heap[indexTwo] = tmp;
};

MaxPriorityQueue.prototype.peek = function () {
...
MaxPriorityQueue.prototype.heapify = function (index) {
